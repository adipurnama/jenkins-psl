...
def merge(Pipeline p){
  ...
  def pr_merge_response = httpRequest authentication: 'gh-adipurnama', httpMode: 'PUT', url: "https://api.github.com/repos/${p.git_user}/${p.repository_name}/pulls/${p.pr_num}/merge", validResponseCodes: '200,405,409', wrapAsMultipart: false
